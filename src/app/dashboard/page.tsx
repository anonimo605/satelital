...
export default function DashboardPage() {
  ...
  const [activeView, setActiveView] = useState<ActiveView>('exchange');
              ...
              {rechargeStep === 'selection' && (
                <div className="space-y-4 animate-in fade-in-50">
                   <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        {[30000, 50000, 100000, 200000, 500000, 1000000].map((amount) => (
              ...
              {user && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Próximamente aquí verás tus registros de inicio de sesión.</p>
                  </div>
                </div>
              )}
            </CardContent>
    ...
    <main className="flex min-h-screen flex-col items-center bg-background pb-24">
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-card border-t shadow-t-lg z-50">
          <div className="grid grid-cols-6 items-center max-w-4xl mx-auto p-2">
            ...
            <Button variant={activeView === 'gift-code' ? 'secondary' : 'ghost'} className="flex flex-col h-auto p-2" onClick={() => setActiveView('gift-code')}>
